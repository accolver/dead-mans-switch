...
describe("VerificationStatus Component", () => {
  ...
  it("should display error state correctly", () => {
    render(
      <VerificationStatus email={testEmail} error="Something went wrong" />,
    )
  ...
  it("should display verified state correctly", () => {
    render(<VerificationStatus email={testEmail} isVerified={true} />)

    expect(screen.getByTestId("verification-success")).toBeInTheDocument()
    expect(
      screen.getByText(/has been verified successfully/),
    ).toBeInTheDocument()
    expect(screen.getByText(testEmail)).toBeInTheDocument()
  })

  it("should display pending state correctly", () => {
    render(<VerificationStatus email={testEmail} isPending={true} />)
  ...
  it("should display default unverified state", () => {
    render(<VerificationStatus email={testEmail} />)
  ...
  it("should apply custom className", () => {
    render(<VerificationStatus email={testEmail} className="custom-class" />)
