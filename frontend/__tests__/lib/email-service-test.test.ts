...
import { getEmailProvider, validateEmailProviderConfig } from '@/lib/email/email-factory';
...
describe('Email Service Test Environment Configuration', () => {
  ...
  describe('Environment Variable Handling', () => {
    ...
    it('should detect missing SendGrid configuration when provider is sendgrid', () => {
      ...
      expect(validation.errors).toContain('SENDGRID_API_KEY environment variable is required');
      expect(validation.errors).toContain('SENDGRID_ADMIN_EMAIL environment variable is required');
    });
