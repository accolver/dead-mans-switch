...
describe('Email Templates', () => {
  ...
  describe('Reminder Email Template', () => {
    ...
    it('should render reminder email with urgency indicators', async () => {
      mockEmailTemplates.renderReminderTemplate.mockReturnValue({
        subject: '⚠️ Reminder: Check-in required in 7 days - Important Document Access',
        html: `
          <div style="background: #fff3cd;">
            <h2>⚠️ Check-in Reminder</h2>
            <p>Hi John Doe,</p>
            <p>You need to check in for "Important Document Access" in 7 days.</p>
        ...
        text: `
          Check-in Reminder
          Hi John Doe,
          You need to check in for "Important Document Access" in 7 days.
    ...
    it('should show high urgency for critical reminders', async () => {
      ...
      mockEmailTemplates.renderReminderTemplate.mockReturnValue({
        subject: '🚨 URGENT: Check-in required in 1 day - Important Document Access',
    ...
    it('should handle different reminder intervals', async () => {
      ...
      for (const interval of intervals) {
        const data = {
          ...
          urgencyLevel: interval.urgency as 'low' | 'medium' | 'high' | 'critical'
        };
  ...
  describe('Secret Disclosure Email Template', () => {
    const disclosureData = {
      ...
      secretContent: 'Emergency contacts:\n- Doctor: +1-555-0123\n- Hospital: +1-555-0456',
    ...
    it('should render disclosure email with sensitive content warnings', async () => {
      mockEmailTemplates.renderDisclosureTemplate.mockReturnValue({
        subject: 'Important Message from John Doe - Family Emergency Information',
        html: `
