/**
 * DEPRECATED: This file contains Supabase-generated types.
 *
 * After migration to Drizzle ORM, use types from:
 * - @/lib/db/schema for table schemas
 * - @/types/index.d.ts for inferred Drizzle types
 *
